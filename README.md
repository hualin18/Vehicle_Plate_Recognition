...
The codes is in codes directory. Codes for plate letter recognition is in training.ipynb, for step by step plate segmentation is in LPR.ipynb. The recognition for whole plate dataset is shown in recognition.ipynb. CNN model named 'classifier_nor_20.h5'is also saved in this directory.
